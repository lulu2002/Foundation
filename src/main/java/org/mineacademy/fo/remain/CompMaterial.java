...
public enum CompMaterial {
    ...
    CHAIN("STONE"),
    CHISELED_NETHER_BRICKS("STONE"),
    CHISELED_POLISHED_BLACKSTONE("STONE"),
    CRACKED_NETHER_BRICKS("STONE"),
    CRACKED_POLISHED_BLACKSTONE_BRICKS("STONE"),
    CRIMSON_BUTTON("STONE"),
    CRIMSON_DOOR("STONE"),
    CRIMSON_FENCE("STONE"),
    CRIMSON_FENCE_GATE("STONE"),
    CRIMSON_FUNGUS("STONE"),
    CRIMSON_HYPHAE("STONE"),
    CRIMSON_NYLIUM("STONE"),
    CRIMSON_PLANKS("STONE"),
    CRIMSON_PRESSURE_PLATE("STONE"),
    CRIMSON_ROOTS("STONE"),
    CRIMSON_SIGN("STONE"),
    CRIMSON_SLAB("STONE"),
    CRIMSON_STAIRS("STONE"),
    CRIMSON_STEM("STONE"),
    CRIMSON_TRAPDOOR("STONE"),
    CRIMSON_WALL_SIGN("STONE"),
    CRYING_OBSIDIAN("STONE"),
    HOGLIN_SPAWN_EGG("MONSTER_EGG"),
    LODESTONE("STONE"),
    NETHERITE_AXE("DIAMOND_AXE"),
    NETHERITE_BLOCK("STONE"),
    ...
    NETHERITE_INGOT("STONE"),
    NETHERITE_LEGGINGS("DIAMOND_LEGGINGS"),
    NETHERITE_PICKAXE("DIAMOND_PICKAGE"),
    NETHERITE_SCRAP("STONE"),
    NETHERITE_SHOVEL("DIAMOND_SHOVEL"),
    NETHERITE_SWORD("DIAMOND_SWORD"),
    NETHER_GOLD_ORE("STONE"),
    NETHER_SPROUTS("STONE"),
    ...
    SOUL_SOIL("STONE"),
    SOUL_TORCH("STONE"),
    SOUL_WALL_TORCH("STONE"),
    STRIPPED_CRIMSON_HYPHAE("STONE"),
    STRIPPED_CRIMSON_STEM("STONE"),
    STRIPPED_WARPED_HYPHAE("STONE"),
    STRIPPED_WARPED_STEM("STONE"),
    TARGET("STONE"),
    TWISTING_VINES("STONE"),
    TWISTING_VINES_PLANT("STONE"),
    WARPED_BUTTON("STONE"),
    WARPED_DOOR("STONE"),
    WARPED_FENCE("STONE"),
    WARPED_FENCE_GATE("STONE"),
    WARPED_FUNGUS("STONE"),
    WARPED_FUNGUS_ON_A_STICK("STONE"),
    WARPED_HYPHAE("STONE"),
    WARPED_NYLIUM("STONE"),
    WARPED_PLANKS("STONE"),
    WARPED_PRESSURE_PLATE("STONE"),
    WARPED_ROOTS("STONE"),
    WARPED_SIGN("STONE"),
    WARPED_SLAB("STONE"),
    WARPED_STAIRS("STONE"),
    WARPED_STEM("STONE"),
    WARPED_TRAPDOOR("STONE"),
    WARPED_WALL_SIGN("STONE"),
    WARPED_WART_BLOCK("STONE"),
    WEEPING_VINES("STONE"),
    WEEPING_VINES_PLANT("STONE");
